...
import { Plus, Search, RotateCcw, ShieldAlert, Loader2, Kanban, List } from 'lucide-react';
        ...
        <div className="space-y-4">
          <div className="flex flex-wrap items-center justify-between gap-4 p-4 border border-zinc-850 bg-zinc-900/10 rounded-xl backdrop-blur-sm">
            ...
            <div className="flex flex-wrap items-center gap-4">
              ...
              {/* View Toggle */}
              <div className="flex items-center border border-zinc-850 bg-zinc-900/40 rounded-lg p-0.5 shadow-inner">
                <Button
                  variant="ghost"
                  size="sm"
                  onClick={() => setViewMode('board')}
                  className={`h-8 px-3 text-xs gap-1.5 cursor-pointer rounded-md transition-all duration-150 ${
                    viewMode === 'board'
                      ? 'bg-zinc-100 text-zinc-900 font-semibold shadow-sm hover:bg-zinc-100'
          ...
          {isLoading ? (
            ...
            <div className="flex flex-col items-center justify-center p-12 border border-red-900/30 rounded-xl bg-red-955/10 min-h-[300px]">
